<template>
  ...
  <nav style="display: flex; justify-content: center; gap: 30px; margin-bottom: 10px; align-items: center; flex-wrap: wrap;">
    ...
    <template v-if="jePrijavljen">
      <button @click="router.push('/ProfilKorisnik')" style="background: none; border: none; color: #00ffff; font-size: 12px; font-weight: bold; cursor: pointer; font-family: inherit;">PROFIL ({{ trenutniKorisnik.username }})</button>
      <button @click="odjavi_se" style="background: none; border: none; color: #ff00ff; font-size: 12px; font-weight: bold; cursor: pointer; font-family: inherit;">ODJAVI SE</button>
    </template>
    <button v-else @click="prijava_stranica" style="background: none; border: none; color: #ff00ff; font-size: 12px; font-weight: bold; cursor: pointer; font-family: inherit;">PRIJAVI SE</button>
  </nav>
</header>
