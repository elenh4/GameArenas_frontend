<template>
  ...
  <nav style="display: flex; justify-content: space-between; align-items: center; position: relative; flex-wrap: wrap; gap: 15px;">
    ...
    <div style="position: absolute; left: 50%; top: 50%; transform: translate(-50%, -50%);">
      <img :src="logo" alt="Game Arenas" style="display: block; max-width: 280px; width: 100%; height: auto;">
    </div>
